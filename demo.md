...
The first thing to remember is that a coding style exists for us to make understanding code easier for a project participant. To this end, a code should be as uniform and idiomatic as
possible similarly with the properties that make usual human speech easier to understand.
...
<details>
  <summary>For Guidelines details!</summary>
  <p>
